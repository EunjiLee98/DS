...
main () 
{
	arraylist_t * interval_vt, * interval_end_vt;
	interval_vt = arraylist_alloc(sizeof(double)) ;
	interval_end_vt = arraylist_alloc(sizeof(double)) ;
...
//		printf("%lf %lf\n", n1, n2);
		...
		arraylist_insert_last(interval_vt, &n1);
		arraylist_insert_last(interval_vt, &n2);
		arraylist_insert_last(interval_end_vt, &n2);
	}

	arraylist_qsort(interval_vt, cmp_double); 
	arraylist_qsort(interval_end_vt, cmp_double);
	
	int i = 0;
	int j = 0;
	while(i < arraylist_length(interval_vt))
	{
		double data1, data2;
		arraylist_get(interval_vt, i , &data1);
		arraylist_get(interval_end_vt, j, &data2);
	...
	printf("%d\n",max);
	//arraylist_print(interval_vt, print_double);
	//printf("\n\n");
	//arraylist_print(interval_end_vt, print_double);
